...
@TestPropertySource(properties = {"PCQ_BACKEND_URL:http://127.0.0.1:4550"})
public class ConsolidationServiceIntegrationTest extends SpringBootIntegrationTest{


    @Rule
    public WireMockRule pcqBackendService = new WireMockRule(WireMockConfiguration.options().port(4550));


    public void pcqWithoutCaseWireMockSuccess() {
